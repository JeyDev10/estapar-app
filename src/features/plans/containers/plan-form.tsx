          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="grid gird-cols-1 md:grid-cols-2 gap-4">
                ...
                <Controller
                  ...
                  render={({ field: { onChange, value } }) => (
                    <>
                      ...
                      />
                      {errors.veichleType && <span className="text-sm text-red-400">{errors.veichleType.message}</span>}
                    </>
                  )}
                />
              </div>
              <div className="flex flex-col w-full">
                ...
                />
                {errors.totalVacancies && <span className="text-sm text-red-400">{errors.totalVacancies.message}</span>}
              </div>
              <div className="flex flex-col w-full">
                ...
                <Controller
                  ...
                  render={({ field: { onChange } }) => (
                    <>
                      ...
                      />
                      {errors.endValidity && <span className="text-sm text-red-400">{errors.endValidity.message}</span>}
                    </>
                  )}
                />
              </div>
